<?php
$page_title       = 'Tak & Fasad Göteborg – Fast Pris & ROT-avdrag';
$page_description = 'M2 Bygg Team AB – tak, fasad och plåtarbeten i Göteborg. Fast pris, ROT-avdrag, 5 år garanti. Lokala hantverkare. Ring 031-96 88 88.';
$active_page      = '';
$breadcrumbs      = [['Hem', '/'], ['Göteborg', null]];
...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:14px">Tak &amp; fasad<br>i Göteborg</h1>
      <p class="animate-in delay-2">Vi renoverar tak och fasader i hela Göteborg med lokala hantverkare och fast pris. Fast pris, ROT-avdrag och 5 år garanti.</p>
...
<section class="section">
  <div class="container">
    <div class="section-header reveal" style="margin-bottom:32px">
      <p class="eyebrow">Tjänster i Göteborg</p>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:start">
      <div class="reveal">
        ...
        <h2 style="margin-bottom:12px">Göteborg är<br>vårt område</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:16px">Vi renoverar tak och fasader i hela Göteborg med lokala hantverkare och fast pris.</p>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:24px">Vi har genomfört 500+ uppdrag i Göteborg och känner till lokala förutsättningar, klimat och byggkrav. Det märks i kvaliteten.</p>
        <h4 style="font-size:14px;color:var(--coal);margin-bottom:12px">Områden vi täcker i Göteborg</h4>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
          <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Hisingen</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Majorna</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Askim</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Hovås</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Torslanda</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Partille</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Mölndal</a>
      <a href="/offert" style="display:flex;align-items:center;gap:8px;background:var(--sand-lt);border:1px solid var(--border);border-radius:var(--r-md);padding:10px 13px;font-size:13.5px;color:var(--coal);transition:all .15s" onmouseover="this.style.borderColor='var(--copper)'" onmouseout="this.style.borderColor='var(--border)'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:13px;height:13px;color:var(--copper);flex-shrink:0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg>Högsbo</a>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;gap:12px" class="reveal-group">
        <?php foreach([['500+','Projekt i Göteborg'],['4,9/5','Google-betyg'],['24h','Svarstid'],['5 år','Garanti']] as $s): ?>
...
<section class="section" style="background:var(--coal)">
  <div class="container">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2 style="color:var(--sand-lt)">Vad kunder i Göteborg säger</h2>
    </div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px" class="reveal-group">
      <?php foreach([
        ['JA','Johan A.','Anlitade M2 för takbyte i Göteborg. Professionellt, fast pris och exakt i tid. Rekommenderas!'],
        ['ML','Maria L.','Fasadmålning – otrolig förvandling. ROT-avdraget hanterades smidigt. Toppenklass!'],
        ['EK','Erik K.','Snabb respons och toppenservice. M2 är det bästa valet i Göteborg. 5 av 5!'],
      ] as $r): ?>
      <div class="review-card reveal" style="background:var(--coal-soft);border-color:rgba(255,255,255,.07)">
        ...
        <div class="review-card__author">
          ...
          <div><div class="review-card__name" style="color:var(--sand-lt)"><?=$r[1]?></div><div class="review-card__loc">Göteborg · Google</div></div>
...
<section class="cta-band">
  <div class="container">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:28px;flex-wrap:wrap">
      <div class="reveal">
        <p class="eyebrow" style="color:var(--copper-lt);margin-bottom:12px">Behöver du hjälp i Göteborg?</p>
