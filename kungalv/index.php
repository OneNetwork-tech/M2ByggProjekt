...
$page_description = 'M2 Bygg Team AB – tak, fasad och plåtarbeten i Kungälv. Fast pris och ROT-avdrag. Lokala hantverkare. Ring 031-96 88 88.';
$active_page      = '';
...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <p class="animate-in delay-2">Tak och fasad i Kungälv och norra Göteborg, material anpassade för Bohuslän-klimatet..</p>
