...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Takbyte i Göteborg</h1>
      <p class="animate-in delay-2">Komplett takbyte av alla taktyper. Vi demonterar, kontrollerar underlag och lägger nytt tak med rätt material och teknik. Fast pris – inga överraskningar.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Alla taktyper – tegeltak, betongtak, plåttak, papptak</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Komplett service ingår – demontering, underlag, ytmaterial</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>ROT-avdrag – vi hanterar ansökan åt dig</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>5 år garanti på allt takarbete</li></ul>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      ...
      <div class="reveal">
        ...
        <h2 style="margin-bottom:12px">Komplett takbyte från start till mål</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">Demontering, underlagskontroll, nytt undertäcksmaterial och ytmaterial ingår alltid i det fasta priset. Inga dolda kostnader, aldrig.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om takbyte göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar ett takbyte i Göteborg?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Beroende på taktyp och storlek kostar ett takbyte 120 000–250 000 kr för en normal villa. Med ROT-avdrag reduceras arbetskostnaden med 30%. Vi ger alltid fast pris efter gratis besiktning.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Hur lång tid tar ett takbyte?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">3–7 arbetsdagar för ett normalt villa (120–180 m²) beroende på taktyp och väder. Vi informerar alltid om tidsplan i förväg.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Kan jag bo kvar under takbytet?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Ja, i de flesta fall. Vi täcker öppningarna varje kväll för att skydda huset. Det kan vara bullrigt dagtid men vi informerar alltid om schema.</div></div></div>
  </div>
</section>
