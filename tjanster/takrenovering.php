...
<div class="breadcrumb"><div class="container"><div class="breadcrumb__inner">
  ...
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  <span>Takrenovering Göteborg</span>
</div></div></div>
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Takrenovering i Göteborg</h1>
      <p class="animate-in delay-2">Partiell takrenovering – vi lagar läckor, byter skadade pannor och åtgärdar konstruktionsfel utan att byta hela taket. Kostnadseffektivt alternativ med fast pris.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Partiell renovering – byt bara det som behövs</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Åtgärdar orsaken, inte bara symtomen</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>ROT-avdrag upp till 50% på arbetet</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>5 år garanti på utfört arbete</li></ul>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1632207691143-643e2a9a9361?w=1600&q=80" alt="Takrenovering Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <span class="price-badge" style="margin-bottom:16px">Fast pris – offert efter besiktning</span>
        <h2 style="margin-bottom:12px">Spara pengar med rätt diagnos</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">Vi besiktar alltid taket grundligt och ger dig ett ärligt råd. Om partiell renovering räcker rekommenderar vi det – vi förespråkar aldrig onödigt arbete.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om takrenovering göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Hur vet jag om jag behöver renovera eller byta hela taket?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Vi gör alltid en kostnadsfri besiktning. Om mer än 40–50% av taket behöver åtgärdas rekommenderar vi vanligtvis ett komplett takbyte. Vi ger alltid ett ärligt råd.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Kan ni laga ett tak med aktiv läcka?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Ja, vi hanterar akuta läckor och kan i de flesta fall komma ut inom 24–48 timmar i Göteborg. Ring 031-96 88 88 direkt för akuta ärenden.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Vad kostar takrenovering?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Kostnaden beror på skadans omfattning. En partiell takrenovering kostar vanligtvis 20 000–80 000 kr. Med ROT-avdrag reduceras arbetskostnaden med 30%.</div></div></div>
  </div>
</section>
