<?php
$page_title = 'Plåtarbeten Göteborg';
$page_description = 'Professionella plåtarbeten i Göteborg – hängrännor, stuprör och beslag. Stål, zink, aluminium och koppar. Fast pris. M2 Bygg Team AB.';
$active_page = 'tjanster';
$breadcrumbs = [['Hem', '/'], ['Tjänster', '/tjanster'], ['Plåtarbeten Göteborg', null]];
...
<div class="breadcrumb"><div class="container"><div class="breadcrumb__inner">
  ...
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  <span>Plåtarbeten Göteborg</span>
</div></div></div>
<section class="hero" style="padding:80px 0 70px">
  <div class="hero__bg" style="background-image:url('https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=1600&q=80')"></div>
  <div class="hero__overlay"></div>
  <div class="container hero__content">
    <div style="max-width:600px">
      <p class="eyebrow animate-in" style="color:var(--copper-lt);margin-bottom:18px">Göteborg &amp; Västsverige</p>
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Plåtarbeten i Göteborg</h1>
      <p class="animate-in delay-2">Hängrännor, stuprör, plåtbeslag och plåttak. Rätt plåtarbete skyddar husgrunden och fasaden mot fuktskador. Vi arbetar med stål, zink, aluminium och koppar.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Hängrännor, stuprör och beslag – allt vi hanterar</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Stål, zink, aluminium och koppar</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Skyddar husgrunden mot fuktskador</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>ROT-avdrag och 5 år garanti</li></ul>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=1600&q=80" alt="Plåtarbeten Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <span class="price-badge" style="margin-bottom:16px">Fast pris – offert efter besiktning</span>
        <h2 style="margin-bottom:12px">Komplett plåtservice</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">Från hängrännor och stuprör till plåtbeslag kring skorsten – vi hanterar alla typer av plåtarbeten med material och tekniker som håller i decennier.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om plåtarbeten göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar byte av hängrännor?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Byte av hängrännor på en normal villa kostar typiskt 15 000–45 000 kr beroende på längd och material. Zinkränna håller 50–70 år, stålränna 30–40 år.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">När ska man byta hängrännor?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Tecken på att byte krävs: synlig rost, läckage, sprickor, ränna som hänger snett eller är äldre än 30 år. Läckande ränna kan orsaka allvarliga fuktskador på fasad och grund.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Vilket plåtmaterial ska jag välja?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Zink och koppar håller längst (50–100 år) och passar hus nära havet. Stål är prisvärd och håller 30–40 år. Vi rekommenderar rätt material vid besiktningen.</div></div></div>
  </div>
</section>
