...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Takmålning i Göteborg</h1>
      <p class="animate-in delay-2">Takmålning som förnyar och skyddar ditt tak i 10–15 år. Vi förbereder ytan noggrant och använder premiumprodukter anpassade för Göteborgs klimat.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Förnyar taket i 10–15 år – kostnadseffektivt alternativ</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Grundlig förbehandling ingår alltid</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Premiumprodukter för Göteborgs fuktiga klimat</li>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1632207691143-643e2a9a9361?w=1600&q=80" alt="Takmålning Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <span class="price-badge" style="margin-bottom:16px">från 150 kr/m²</span>
        <h2 style="margin-bottom:12px">Kostnadseffektivt skydd</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">Med rätt förberedelse och premiumprodukter håller en takmålning 10–15 år i Göteborgs klimat till en bråkdel av ett nytt tak.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om takmålning göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar takmålning per m²?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Takmålning kostar normalt 150–280 kr/m² inklusive tvätt, primerbehandling och målning. Med ROT-avdrag reduceras arbetskostnaden med 30%.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Hur förbereder ni taket innan målning?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Vi högtryckstvättar alltid taket och behandlar mot mossa och alger innan vi grundar och målar. Korrekt förberedelse är avgörande – det ingår alltid.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Vilket tak lämpar sig för takmålning?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Betongpannor, tegeltak och fibercement. Taket bör vara i gott strukturellt skick. Vid besiktningen bedömer vi om målning eller renovering är rätt åtgärd.</div></div></div>
  </div>
</section>
