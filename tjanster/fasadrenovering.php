<?php
$page_title = 'Fasadrenovering Göteborg';
$page_description = 'Professionell fasadrenovering i Göteborg till fast pris. Lagning av sprickor och skador på alla fasadtyper. ROT-avdrag. M2 Bygg Team AB.';
$active_page = 'tjanster';
$breadcrumbs = [['Hem', '/'], ['Tjänster', '/tjanster'], ['Fasadrenovering Göteborg', null]];
...
<div class="breadcrumb"><div class="container"><div class="breadcrumb__inner">
  ...
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  <span>Fasadrenovering Göteborg</span>
</div></div></div>
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Fasadrenovering i Göteborg</h1>
      <p class="animate-in delay-2">Komplett fasadrenovering med lagning av sprickor, skador och åldrande fasadmaterial. Rätt teknik för varje fasadtyp – resultat som håller i 15–20 år.</p>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&q=80" alt="Fasadrenovering Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om fasadrenovering göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar fasadrenovering?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Kostnaden beror på fasadtyp och skadans omfattning. Typiskt 200–400 kr/m² för en komplett fasadrenovering inklusive lagning och målning. Vi ger alltid fast pris efter besiktning.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Vilka fasadtyper kan ni renovera?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Alla typer: putsfasader, träfasader, tegelfasader, skivfasader och sandwichpaneler. Vi väljer alltid rätt metod och material för din specifika fasadtyp.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Hur vet jag om jag behöver fasadrenovering?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Tecken: synliga sprickor, flagande färg, fuktfläckar inomhus, mögel eller missfärgning, eller fasad äldre än 10–15 år. Vi gör alltid en gratis besiktning och ärlig bedömning.</div></div></div>
  </div>
</section>
