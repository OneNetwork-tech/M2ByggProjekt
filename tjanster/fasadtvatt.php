...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Fasadtvätt i Göteborg</h1>
      <p class="animate-in delay-2">Högtryckstvätt och biocidbehandling av fasader i Göteborg. Effektiv rengöring mot mögel och alger som förlänger fasadens livslängd och skjuter upp nästa ommålning.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Högtryckstvätt och mögelbehandling</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Förlänger fasadens livslängd – skjuter upp ommålning</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>ROT-avdrag gäller på fasadtvätt</li>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&q=80" alt="Fasadtvätt Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <span class="price-badge" style="margin-bottom:16px">från 100 kr/m²</span>
        <h2 style="margin-bottom:12px">En god investering</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">Fasadtvätt är det billigaste sättet att förlänga tiden till nästa ommålning. En ren fasad utan mögel och alger håller färgen dubbelt så länge.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om fasadtvätt göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar fasadtvätt?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Fasadtvätt kostar 100–200 kr/m² beroende på skick och fasadtyp. En normal villa kostar ca 10 000–25 000 kr. ROT-avdrag gäller. Vi ger alltid fast pris.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Hur ofta ska man tvätta fasaden?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">I Göteborgs fuktiga klimat rekommenderar vi fasadtvätt var 5–8 år, eller direkt om du ser mögel eller alger. Fasad nära hav eller skog behöver tvättas oftare.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Kan högtryckstvätt skada fasaden?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Inte om det görs rätt. Vi anpassar alltid trycket efter fasadmaterialet. Puts och trä kräver lägre tryck och varsam hantering – vi vet exakt hur.</div></div></div>
  </div>
</section>
