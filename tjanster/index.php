...
$page_description = 'Alla tjänster från M2 Bygg Team AB – takbyte, takmålning, fasadmålning, klä in fasad, balkongmålning, plåtarbeten och stenläggning. Fast pris och ROT-avdrag i Göteborg och Västsverige.';
...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content" style="text-align:center">
    <div style="max-width:640px;margin:0 auto">
      <p class="eyebrow animate-in" style="color:var(--gold-lt);display:block;margin-bottom:18px">Fast pris · ROT-avdrag</p>
...
<section class="section" style="background:var(--surface)">
  <div class="container">
    <div class="reveal" style="text-align:center;margin-bottom:40px">
      ...
      <p style="max-width:480px;margin:12px auto 0">Fast pris oavsett var i regionen du bor. Ingen resekostnad inom Stor-Göteborg.</p>
    </div>
  ...
  <div class="container">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:28px;flex-wrap:wrap">
      <div class="reveal">
        ...
        <p>Vi utför fler tjänster än vad som visas här. Fast pris gäller alltid.</p>
      </div>
