...
<div class="breadcrumb"><div class="container"><div class="breadcrumb__inner">
  ...
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  <span>Stenläggning Göteborg</span>
</div></div></div>
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Stenläggning i Göteborg</h1>
      <p class="animate-in delay-2">Estetisk och hållbar stenläggning – terrassplattor, uppfarter och gångvägar i natursten och betongsten med korrekt underlag och dränering som håller i 20–50 år.</p>
      <ul style="list-style:none;margin:24px 0 28px;display:flex;flex-direction:column;gap:10px" class="animate-in delay-3"><li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Natursten, betongsten och terrassplattor</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Korrekt underlag och dränering ingår alltid</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>ROT-avdrag gäller på stenläggning</li>
<li style="display:flex;align-items:center;gap:10px;color:rgba(245,245,247,.78);font-size:15px"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:17px;height:17px;color:var(--copper-lt);flex-shrink:0"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Fast pris och 5 år garanti</li></ul>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1600&q=80" alt="Stenläggning Göteborg Göteborg" loading="lazy" style="width:100%;height:460px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <span class="price-badge" style="margin-bottom:16px">från 500 kr/m²</span>
        <h2 style="margin-bottom:12px">Estetik och hållbarhet</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:28px">En vällagd stenyta håller i 20–50 år med rätt underlag, korrekt dränering och material anpassat till Göteborgs frostklimat. Vi gör det rätt från start.</p>
...
<section class="section" style="background:var(--sand-lt)">
  <div class="container container--narrow">
    <div class="section-header reveal" style="margin-bottom:28px">
      ...
      <h2>Frågor om stenläggning göteborg</h2>
    </div>
    <div class="faq-item reveal"><button class="faq-q">Vad kostar stenläggning i Göteborg?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Stenläggning kostar 500–1 500 kr/m² beroende på material och komplexitet. Natursten är dyrare men håller längst. Vi ger alltid fast pris efter besiktning.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Hur lång tid tar stenläggning?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">En terrassyta på 30–50 m² tar normalt 2–4 dagar inklusive underlagsarbete. Vi börjar alltid med korrekt underlag och dränering – grunden för ett hållbart resultat.</div></div></div>
<div class="faq-item reveal"><button class="faq-q">Gäller ROT-avdrag på stenläggning?<div class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></div></button><div class="faq-a"><div class="faq-a-inner">Ja, stenläggning på din fastighet – terrass, uppfart och gångvägar – berättigar till ROT-avdrag med 30% på arbetskostnaden. Vi hanterar ansökan åt dig.</div></div></div>
  </div>
</section>
