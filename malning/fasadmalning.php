<?php
$page_title = 'Fasadmålning Göteborg – Skydd & Förnyelse';
$page_description = 'Professionell fasadmålning i Göteborg. Vi utför både inomhus- och utomhusmålning med rätt färgval och gediget förarbete. M2 Bygg Team AB.';
$active_page = 'malning';
$breadcrumbs = [['Hem', '/'], ['Målning', '/malning'], ['Fasadmålning', null]];
...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <h1 class="animate-in delay-1" style="margin-bottom:16px">Fasadmålning</h1>
      <p class="animate-in delay-2">Vi utför professionell fasadmålning med rätt färgval, gediget förarbete och hög finish. Färgen bleknar och ytor utsätts för påfrestningar från väder och vind – regelbunden målning ger nytt liv och bättre skydd.</p>
...
<section class="section">
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:68px;align-items:center">
      <div class="reveal">
        <img src="/uploads/gallery/fasadmalning-efter.avif" alt="Fasadmålning efter" loading="lazy" style="width:100%;height:380px;object-fit:cover;border-radius:var(--r-xl);box-shadow:var(--shadow-xl)">
      </div>
      <div class="reveal">
        <h2 style="margin-bottom:12px">Kvalitet som håller</h2>
        <p style="color:var(--steel);line-height:1.72;margin-bottom:20px">God förberedelse – tvätt, skrapning och grundning – är avgörande för ett hållbart resultat. Vi använder kvalitetsfärg anpassad för det svenska klimatet.</p>
