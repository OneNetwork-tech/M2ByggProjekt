...
$page_description = 'M2 Bygg Team AB – tak, fasad och plåtarbeten i Trollhättan. Fast pris och ROT-avdrag. Lokala hantverkare. Ring 031-96 88 88.';
$active_page      = '';
...
<section class="hero" style="padding:80px 0 70px">
  ...
  <div class="container hero__content">
    <div style="max-width:600px">
      ...
      <p class="animate-in delay-2">Tak och fasad i Trollhättan och Vänersborgstrakten. Fast pris.</p>
  ...
  <div class="container">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:start">
      <div class="reveal">
        ...
        <p style="color:var(--steel);line-height:1.72;margin-bottom:16px">Tak och fasad i Trollhättan och Vänersborgstrakten. Fast pris.</p>
